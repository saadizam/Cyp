    ...
    <form id="form1" runat="server" class="auto-style4">
        ...
        <div class="auto-style1">
            ...
            <div class="auto-style5">
                ...
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:BuzyBeezCYPConnectionString1 %>" SelectCommand="SELECT [Name] FROM [Accounts]"></asp:SqlDataSource>
                <br />
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:BuzyBeezCYPConnectionString1 %>" SelectCommand="SELECT [Name] FROM [location]"></asp:SqlDataSource>
            <div class="auto-style5">
                <strong>
            <br />
...
initialize();
            ...
            <asp:Panel ID="Panel2" runat="server" Height="913px">
                <div class="auto-style5">
                    ...
                    <br />
                    <br />
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BuzyBeezCYPConnectionString1 %>" DeleteCommand="DELETE FROM [vehfixedfare] WHERE [ID] = @ID" InsertCommand="INSERT INTO [vehfixedfare] ([Name], [A], [B]) VALUES (@Name, @A, @B)" SelectCommand="SELECT * FROM [vehfixedfare]" UpdateCommand="UPDATE [vehfixedfare] SET [Name] = @Name, [A] = @A, [B] = @B WHERE [ID] = @ID">
                        <DeleteParameters>
