...
<body>
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" NavigateUrl="FixedrateDetails.aspx">BACK</asp:HyperLink>
        <br />
        <br />
        <h1><em>Crystal Palace Booking </em></h1>
...
DataNavigateUrlFormatString="/ViewBooking.aspx?id={0}"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BuzyBeezCYPConnectionString1 %>" DeleteCommand="DELETE FROM [BookingPortalCYP] WHERE [id] = @id" InsertCommand="INSERT INTO [BookingPortalCYP] ([account], [creditcard], [custname], [date], [datentime], [fare], [flightno], [from], [jobmileage], [jobref], [office], [telephone], [time], [to], [Via1address], [Passengers], [commentt]) VALUES (@account, @creditcard, @custname, @date, @datentime, @fare, @flightno, @from, @jobmileage, @jobref, @office, @telephone, @time, @to, @Via1address, @Passengers, @commentt)" SelectCommand="SELECT [id], [account], [creditcard], [custname], [date], [datentime], [fare], [flightno], [from], [jobmileage], [jobref], [office], [telephone], [time], [to], [Via1address], [Passengers], [commentt],[Status] FROM [BookingPortalCYP] ORDER BY [id] DESC" UpdateCommand="UPDATE [BookingPortalCYP] SET [account] = @account, [creditcard] = @creditcard, [custname] = @custname, [date] = @date, [datentime] = @datentime, [fare] = @fare, [flightno] = @flightno, [from] = @from, [jobmileage] = @jobmileage, [jobref] = @jobref, [office] = @office, [telephone] = @telephone, [time] = @time, [to] = @to, [Via1address] = @Via1address, [Passengers] = @Passengers, [commentt] = @commentt WHERE [id] = @id">
            <DeleteParameters>
