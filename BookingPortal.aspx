    ...
    <div class="container arcontainer">
        <div class="col-md-6">
            <div class="container arcontainer arcontainer2">
                           <div class="row"> <div class="col-half frm1" style=" font-size: x-small; color: #ffb118;"><h1 style=" border-left: solid #54554e; padding-left: 10px;color:#3d356f;">SELECT YOUR JOURNEY DETAILS</h1></div> <div class="col-half drnm"> <div class="input-group input-group-icon" style="margin-bottom: 0;"> <input name="TextBox27" id="TextBox27" readonly="readonly" type="text" class="ar-input" style="font-size: x-large;padding-left: 0;font-family: fantasy;height: 10px;background: #3d356f;color: white;"> <div class="input-icon" style=" color: white; font-size: x-large; line-height: 52px; height: 50px; left: -30px; width: 120px;"><i class="fa fa-gbp"></i></div> </div><br> </div> </div>
                    ...
                    <div class="row">
                        <div class="col-half drnm">
                            <div class="input-group input-group-icon">
                                ...
                                <div class="input-icon"><i class="fa fa-hospital-o"></i></div>
                            </div>
                        </div>
...
<form id="form1" runat="server">
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-half">
                                <div class="input-group input-group-icon" style="margin: 0;">
                                    <asp:TextBox ID="time" runat="server" AutoPostBack="true" OnTextChanged="time_TextChanged" type="time" value="Booking Time"></asp:TextBox>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="container arcontainer arcontainer2">
                <div class="auto-style73">
                    ...
                    <div class="container arcontainer arcontainer2" style="background: rgba(50, 50, 50, 0.45);">
                        <div class="row">
